...
namespace TizianaTerenzi.Identity.Data.Migrations
{
    ...
    /// <inheritdoc />
    public partial class Add_Chat_Related_Entities_And_Emojis_Entity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatUserGroups_ChatGroups_ChatGroupId",
                        column: x => x.ChatGroupId,
                        principalTable: "ChatGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatUserGroups_ChatGroupId",
                table: "ChatUserGroups",
                column: "ChatGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatUserGroups_IsDeleted",
                table: "ChatUserGroups",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ChatUserGroups_UserId",
                table: "ChatUserGroups",
                column: "UserId");
